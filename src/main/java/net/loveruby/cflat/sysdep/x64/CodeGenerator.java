...
public class CodeGenerator implements net.loveruby.cflat.sysdep.CodeGenerator,
    ...
    public CodeGenerator(CodeGeneratorOptions options, ErrorHandler errorHandler) {
        this.options = options;
        this.naturalType = Type.INT64;
...
//        body.reduceLabels();
    ...
    // 只用到少量存器
    // cbc 1.0 代码里用 ax 指的是 eax;  64位下就是 rax
    private Register ax() { return rax(); }
    private Register bx() { return rbx(); }
    private Register cx() { return rcx(); }
    private Register dx() { return rcx(); }

    private Register rax() { return ax(naturalType); }
    private Register eax() { return ax(Type.INT32); }
    // private Register ax() { return ax(Type.INT16); }
    private Register al() { return ax(Type.INT8); }

    private Register rbx() { return bx(naturalType); }
    private Register ebx() { return bx(Type.INT32); }
    // private Register bx() { return bx(Type.INT16); }
    private Register bl() { return bx(Type.INT8); }

    private Register rcx() { return cx(naturalType); }
    private Register ecx() { return cx(Type.INT32); }
    // private Register cx() { return cx(Type.INT16); }
    private Register cl() { return cx(Type.INT8); }

    private Register rdx() { return dx(naturalType); }
    private Register edx() { return dx(Type.INT32); }
    // private Register dx() { return dx(Type.INT16); }
    private Register dl() { return dx(Type.INT8); }

    private Register rsi() { return si(naturalType); }
    private Register esi() { return si(Type.INT32); }
    private Register si() { return si(Type.INT16); }
    private Register sil() { return si(Type.INT8); }

    private Register rdi() { return di(naturalType); }
    private Register edi() { return di(Type.INT32); }
    private Register di() { return di(Type.INT16); }
    private Register dil() { return di(Type.INT8); }

    private Register bp() { return rbp(); }
    private Register rbp() { return bp(naturalType); }
    private Register ebp() { return bp(Type.INT32); }
    // private Register bp() { return bp(Type.INT16); }
    private Register bpl() { return bp(Type.INT8); }

    private Register sp() { return rsp(); }
    private Register rsp() { return sp(naturalType); }
    private Register esp() { return sp(Type.INT32); }
    // private Register sp() { return sp(Type.INT16); }
    private Register spl() { return sp(Type.INT8); }

    private Register r8() { return r8(naturalType); }
    private Register r8d() { return r8(Type.INT32); }
    private Register r8w() { return r8(Type.INT16); }
    private Register r8b() { return r8(Type.INT8); }

    private Register r9() { return r9(naturalType); }
    private Register r9d() { return r9(Type.INT32); }
    private Register r9w() { return r9(Type.INT16); }
    private Register r9b() { return r9(Type.INT8); }

    private Register r10() { return r10(naturalType); }
    private Register r10d() { return r10(Type.INT32); }
    private Register r10w() { return r10(Type.INT16); }
    private Register r10b() { return r10(Type.INT8); }

    private Register r11() { return r11(naturalType); }
    private Register r11d() { return r11(Type.INT32); }
    private Register r11w() { return r11(Type.INT16); }
    private Register r11b() { return r11(Type.INT8); }

    private Register r12() { return r12(naturalType); }
    private Register r12d() { return r12(Type.INT32); }
    private Register r12w() { return r12(Type.INT16); }
    private Register r12b() { return r12(Type.INT8); }

    private Register r13() { return r13(naturalType); }
    private Register r13d() { return r13(Type.INT32); }
    private Register r13w() { return r13(Type.INT16); }
    private Register r13b() { return r13(Type.INT8); }

    private Register r14() { return r14(naturalType); }
    private Register r14d() { return r14(Type.INT32); }
    private Register r14w() { return r14(Type.INT16); }
    private Register r14b() { return r14(Type.INT8); }

    private Register r15() { return r15(naturalType); }
    private Register r15d() { return r15(Type.INT32); }
    private Register r15w() { return r15(Type.INT16); }
    private Register r15b() { return r15(Type.INT8); }
    ...
    private Register si(Type t) {
        return new Register(RegisterClass.SI, t);
    }
    private Register di(Type t) {
        return new Register(RegisterClass.DI, t);
    }
    private Register bp(Type t) {
        return new Register(RegisterClass.BP, t);
    }
    private Register sp(Type t) {
        return new Register(RegisterClass.SP, t);
    }
    private Register r8(Type t) {
        return new Register(RegisterClass.R8, t);
    }
    private Register r9(Type t) {
        return new Register(RegisterClass.R9, t);
    }
    private Register r10(Type t) {
        return new Register(RegisterClass.R10, t);
    }
    private Register r11(Type t) {
        return new Register(RegisterClass.R11, t);
    }
    private Register r12(Type t) {
        return new Register(RegisterClass.R12, t);
    }
    private Register r13(Type t) {
        return new Register(RegisterClass.R13, t);
    }
    private Register r14(Type t) {
        return new Register(RegisterClass.R14, t);
    }
    private Register r15(Type t) {
        return new Register(RegisterClass.R15, t);
    }
